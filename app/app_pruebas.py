...
st.markdown(
    "<style>h1 {color: #0366d6; text-align: center;}</style>", 
...
page = st.sidebar.selectbox(
    ...
    (
        "Introducción a GitHub y contenido del taller",
        "Resumen lista comandos básicos",
        "Enlaces a repositorios",
        "Ejercicio práctico en grupos"
    ),
    index=None,
    placeholder="Selección de contenido"
)
